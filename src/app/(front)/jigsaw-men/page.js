...
export default function jigsawmen() {
    const menImage = "/download.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(menImage);
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Jigsaw Men Puzzle Online Fun</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={menImage}
                        alt="Jigsaw Men puzzle game online free brain-teasing jigsaw challenge"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
