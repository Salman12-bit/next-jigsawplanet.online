...
export default function JigsawArt() {
    const artImage = "/images/jigsawsand.webp";
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle12")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle12")) || [];
        ...
        localStorage.setItem("puzzle12", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Enjoy Art Jigsaw Puzzle Online Puzzle Game</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={artImage}
                        alt="Art Jigsaw Puzzle Online Free Puzzle Game with Stunning Artwork"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
