...
export default function JigsawNight() {
    const nightImage = "/images/nightstar.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(nightImage);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle9")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle9")) || [];
        ...
        localStorage.setItem("puzzle9", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Online Jigsaw Puzzles for Kids Fun & Learning Games</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={nightImage}
                        alt="Kids Jigsaw Puzzle Online Free Fun Learning Game for Children"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
