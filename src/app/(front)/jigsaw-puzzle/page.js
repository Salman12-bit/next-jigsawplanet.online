...
export default function JigsawDisney() {
    const JigsawImage = "/images/Puzzle3.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(JigsawImage);
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle1")) || [];
        ...
        localStorage.setItem("puzzle1", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Disney Jigsaw Puzzles Online</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={JigsawImage}
                        alt="Free Disney jigsaw puzzle game with colorful characters"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
