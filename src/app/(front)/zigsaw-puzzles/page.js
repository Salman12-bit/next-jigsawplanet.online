...
export default function jigsawAdults() {
    const adultImage = "/images/riverboat.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(adultImage);
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Free Online Jigsaw Puzzle for Adults</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={adultImage}
                        alt="Adult playing free jigsaw puzzle online with colorful pieces"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
