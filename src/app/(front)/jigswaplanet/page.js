...
export default function jigsawCartoon() {
    const cartoonImage = "/images/dorapuzzle.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(cartoonImage);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle10")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle10")) || [];
        ...
        localStorage.setItem("puzzle10", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Online Jigsaw Puzzle Pieces Game</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={cartoonImage}
                        alt="Jigsaw Puzzle Pieces Online Free Fun Puzzle Game for All Ages"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
