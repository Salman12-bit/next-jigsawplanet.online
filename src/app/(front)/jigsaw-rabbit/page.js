...
export default function jigsawRabbit() {
    const rabbitImage = "/images/rabbit.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(rabbitImage);
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle5")) || [];
        ...
        localStorage.setItem("puzzle5", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Rabbit Jigsaw Puzzle Online</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={rabbitImage}
                        alt="Rabbit Jigsaw Puzzle Online Free Bunny Puzzle Game"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
