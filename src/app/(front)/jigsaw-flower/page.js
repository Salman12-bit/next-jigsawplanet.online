...
export default function jigsawflower() {
    const flowerImage = "/flower.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(flowerImage);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle3")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle3")) || [];
        ...
        localStorage.setItem("puzzle3", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Flower Jigsaw Puzzle Online Game</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={flowerImage}
                        alt="Beautiful Flower Jigsaw Puzzle Free Online Puzzle Game"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
