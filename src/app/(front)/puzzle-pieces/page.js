...
export default function jigsawPieces() {
    const piecesImage = "/images/large-puzzle.webp";
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Big Puzzle Pieces Online</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={piecesImage}
                        alt="Big puzzle pieces jigsaw game online for free play"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
