...
export default function JigsawChildren() {
    const childrenImage = "/images/children.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(childrenImage);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle4")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle4")) || [];
        ...
        localStorage.setItem("puzzle4", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Childrens Jigsaw Puzzle for Kids</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={childrenImage}
                        alt="Childrens Jigsaw Puzzle Online Free Fun Puzzle Game for Kids"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
