...
export default function rompecabezas() {
    const rompecabezas = "/images/rompecabezas.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(rompecabezas);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle13")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle13")) || [];
        ...
        localStorage.setItem("puzzle13", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Disfruta de Rompecabezas Online Gratis</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={rompecabezas}
                        alt="Juego de rompecabezas gratis con piezas de colores"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
            ...
            {showFinishModal && (
                <div className={styles.modalOverlay}>
                    <div className={styles.modalContent}>
                        <h2>¡Felicidades!</h2>
                        <p>Has resuelto el rompecabezas en {formatTime(time)}. ¡Gran trabajo!</p>
