...
export default function jigsawCat() {
    const catImage = "/images/jigsawtruck.webp";
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle15")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle15")) || [];
        ...
        localStorage.setItem("puzzle15", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Cat Jigsaw Puzzle Online</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={catImage}
                        alt="Cat jigsaw puzzle with cute kitten pieces"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
