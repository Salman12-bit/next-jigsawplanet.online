...
export default function jigsawWater() {
    const waterImage = "/images/homewater.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(waterImage);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle8")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle8")) || [];
        ...
        localStorage.setItem("puzzle8", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free 24 Piece Jigsaw Puzzle</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={waterImage}
                        alt="24 Piece Jigsaw Puzzle Online Free Easy Puzzle Game"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
