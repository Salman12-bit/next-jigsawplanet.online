...
export default function Puzzle() {
    const tableImage = "/images/burjkhalifa.webp";
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle16")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle16")) || [];
        ...
        localStorage.setItem("puzzle16", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Jigsaw Puzzle Tabletop</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={tableImage}
                        alt="Free online jigsaw puzzle tabletop game with colorful pieces"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
