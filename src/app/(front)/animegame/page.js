...
export default function jigsawAnime() {
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle11")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle11")) || [];
        ...
        localStorage.setItem("puzzle11", JSON.stringify(top7));
        setLeaderboard(top7);
    };
