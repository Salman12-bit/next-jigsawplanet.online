...
export default function jigsawEiffel() {
    const eiffelImage = "/images/eiffel.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(eiffelImage);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle6")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle6")) || [];
        ...
        localStorage.setItem("puzzle6", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Eiffel Tower Jigsaw Puzzle Online Paris Fun</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={eiffelImage}
                        alt="Eiffel Tower Jigsaw Puzzle Online Free Paris Puzzle Game"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
