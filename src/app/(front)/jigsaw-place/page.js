...
export default function jigsawPlace() {
    const placeImage = "/images/place.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(placeImage);
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle7")) || [];
        ...
        localStorage.setItem("puzzle7", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Play Free Planet Jigsaw Puzzle with Space Adventure</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={placeImage}
                        alt="Planet Jigsaw Puzzle Online Free Space Puzzle Game"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
