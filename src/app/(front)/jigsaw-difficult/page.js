...
export default function JigsawDiffcult() {
    const difficultImage = "/images/jigsaw-plaet.webp";
    ...
    useEffect(() => {
        async function processImage() {
            try {
                const img = await loadImage(difficultImage);
    ...
    useEffect(() => {
        const savedData = JSON.parse(localStorage.getItem("puzzle14")) || [];
    ...
    const updateLeaderboard = (name, time) => {
        ...
        const currentLeaderboard = JSON.parse(localStorage.getItem("puzzle14")) || [];
        ...
        localStorage.setItem("puzzle14", JSON.stringify(top7));
        setLeaderboard(top7);
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.sidebar}>
                <h1 className={styles.centerText}>Free Difficult Jigsaw Puzzles Online for Puzzle Lovers</h1>
                <div className={styles.imageContainer}>
                    <img
                        src={difficultImage}
                        alt="Difficult jigsaw puzzle with many small pieces"
                        style={{
                            height: "200px",
                            width: "200px",
                            borderRadius: "10px",
